...
namespace Core
{
    public class BuildingAttackCommandExecutor : CommandExecutorBase<IAttackCommand>
    {
        public class AttackOperation : IAwaitable<AsyncExtensions.Void>
        {
            ...
            private readonly BuildingAttackCommandExecutor _attackCommandExecutor;
            private readonly IAttackable _target;

            private bool _isCancelled;

            public AttackOperation(BuildingAttackCommandExecutor attackCommandExecutor, IAttackable target)
            {
                _target = target;
        ...
        private void Init()
        {
            //_targetPositions.Select(value => new Vector3((float)Math.Round(value.x, 2),
